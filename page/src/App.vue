    ...
    <header class="topbar">
      ...
      <div class="controls">
        <div v-if="messages.length > 0" class="zoom-group" title="Timeline zoom">
          <button class="btn ghost sq" type="button" :disabled="pixelsPerSecond <= PPS_MIN" @click="zoomOut">−</button>
          <span class="zoom-label">{{ pixelsPerSecond }} px/s</span>
          <button class="btn ghost sq" type="button" :disabled="pixelsPerSecond >= PPS_MAX" @click="zoomIn">+</button>
        </div>
