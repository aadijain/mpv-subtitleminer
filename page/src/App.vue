<script setup lang="ts">
  ...
  // existing Anki/media flow; `selectedSecondary` is display/selection only until Part 3.
...
<template>
  <div class="app" :style="{ '--selection-bar-height': `${selectionBarHeight}px` }">
    ...
    <main ref="mainRef" class="main">
      ...
      <div v-else class="timeline" :class="{ 'hide-secondary': !settings.display.showSecondaryColumn }">
        <div class="tl-head">
...
<style scoped>
  ...
  /* collapsed-gap marker spanning the whole width (a deliberate break in the time axis) */
  /* gap marker is centered within the primary column (matches .tl-lane.primary geometry) */
  .tl-gap {
    position: absolute;
    left: 56px;
